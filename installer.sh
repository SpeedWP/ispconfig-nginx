...
apt-get update
apt-get update && apt-get upgrade -y && apt-get install apt-transport-https htop software-properties-common python-software-properties -y
apt-get install git vim wget zip unzip ca-certificates -y

add-apt-repository 'deb [arch=amd64,i386,ppc64el] http://mariadb.cu.be/repo/10.2/debian jessie main'
